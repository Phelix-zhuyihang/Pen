...
[![Release](https://img.shields.io/badge/version-v1.5.1-blue.svg)](https://github.com/) 
...
将文件内容推送到指定 URL，-force 参数可以强制覆盖已存在的内容。支持自动识别文本编码（UTF-8/GBK/GB2312），二进制文件会被拦截并给出提示。
